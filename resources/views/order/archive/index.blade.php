...
@section('content')
    ...
    <!-- Dashboard section Starts -->
            ...
            <div class="w-5/6 px-10 ml-auto border-l dashboard__details">
                ...
                <!-- Details & Update -->
                <div class="flex items-center justify-between w-full pt-16 pb-10 details-update">
                    <!-- Details Info -->
                    <div class="details__info">
                        ...
                        <p class="info__sub-title font-sans font-normal text-[12px] leading-6 text-[#4E484A]">
                            Trades that are completed/failed
                        </p>
                    </div>
                    <!-- Select -->
                    <form>
                    ...
                    <table class="w-full table-fixed">
                        <thead>
                            <tr class="border-b">
                                ...
                                <th class="w-1/4 py-4 font-roboto font-semibold text-base text-[#242634]">Buyer</th>
                                <th class="w-1/4 py-4 font-roboto font-semibold text-base text-[#242634]">Seller</th>
                                <th class="w-1/4 py-4 font-roboto font-semibold text-base text-[#242634] hidden xsm:table-cell">Archived at</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($trades as $trade)
                                <tr class="border-b">
                                    ...
                                    <td class="w-1/4 py-4 text-center font-sans font-normal text-sm text-[#4E484A]">{{ isset($trade->buyer) ? $nameConversionHelper->generateFullName($trade->buyer) : '' }}</td>
                                    ...
                                    <td class="w-1/4 py-4 text-center font-sans font-normal text-sm text-[#4E484A] hidden xsm:table-cell">{{ $trade->updated_at->format('d F, Y') }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
