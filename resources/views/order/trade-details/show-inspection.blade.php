    ...
    <div class="dashboard__details w-5/6 ml-auto border-l">
        ...
        <div class="vehicle__status py-20 px-5 md:px-10">
            ...
            <div class="status__checkbox flex justify-center mt-10">
                ...
                <!-- Item Checkbox -->
                <div class="w-.75/12">
                    <div class="item__checkbox w-[50px] h-[50px] flex justify-center items-center {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'inspector_assigned') ? 'bg-blue' : '' }} border-blue border-2 rounded-full z-50">
                        <svg width="26" height="20" viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21.9585 0.63764C22.4078 0.224133 23.0057 -0.0044712 23.626 6.62771e-05C24.2463 0.00460376 24.8406 0.241928 25.2833 0.661961C25.7261 1.08199 25.9828 1.65188 25.9992 2.25137C26.0156 2.85086 25.7904 3.43307 25.3712 3.87513L12.6453 19.2609C12.4265 19.4888 12.1623 19.6716 11.8687 19.7985C11.5751 19.9255 11.2581 19.9938 10.9365 19.9996C10.615 20.0054 10.2955 19.9484 9.99725 19.832C9.69899 19.7157 9.42806 19.5424 9.20066 19.3226L0.761351 11.1641C0.52633 10.9524 0.337826 10.6971 0.207084 10.4134C0.0763413 10.1298 0.00603925 9.82356 0.000372273 9.51306C-0.00529471 9.20256 0.0537896 8.89413 0.174099 8.60619C0.294409 8.31824 0.47348 8.05667 0.700629 7.83708C0.927778 7.61749 1.19835 7.44438 1.49621 7.32807C1.79407 7.21177 2.11311 7.15465 2.43429 7.16013C2.75548 7.16561 3.07224 7.23357 3.36567 7.35996C3.65909 7.48635 3.92318 7.66858 4.14218 7.89578L10.8209 14.3492L21.8979 0.705474C21.9178 0.681735 21.9391 0.659088 21.9617 0.63764H21.9585Z" fill="white"/>
                        </svg>
                    </div>
                ...
                <!-- Item Checkbox -->
                <div class="w-.75/12">
                    <div class="item__checkbox w-[50px] h-[50px] flex justify-center items-center {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'date_of_inspection_finalized') ? 'bg-blue' : '' }} border-blue border-2 rounded-full z-50">
                ...
                <!-- Item Checkbox -->
                <div class="w-.75/12">
                    <div class="item__checkbox w-[50px] h-[50px] flex justify-center items-center {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'generating_inspection_report') ? 'bg-blue' : '' }} border-blue border-2 rounded-full z-50">
                        <svg class="" width="26" height="20" viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21.9585 0.63764C22.4078 0.224133 23.0057 -0.0044712 23.626 6.62771e-05C24.2463 0.00460376 24.8406 0.241928 25.2833 0.661961C25.7261 1.08199 25.9828 1.65188 25.9992 2.25137C26.0156 2.85086 25.7904 3.43307 25.3712 3.87513L12.6453 19.2609C12.4265 19.4888 12.1623 19.6716 11.8687 19.7985C11.5751 19.9255 11.2581 19.9938 10.9365 19.9996C10.615 20.0054 10.2955 19.9484 9.99725 19.832C9.69899 19.7157 9.42806 19.5424 9.20066 19.3226L0.761351 11.1641C0.52633 10.9524 0.337826 10.6971 0.207084 10.4134C0.0763413 10.1298 0.00603925 9.82356 0.000372273 9.51306C-0.00529471 9.20256 0.0537896 8.89413 0.174099 8.60619C0.294409 8.31824 0.47348 8.05667 0.700629 7.83708C0.927778 7.61749 1.19835 7.44438 1.49621 7.32807C1.79407 7.21177 2.11311 7.15465 2.43429 7.16013C2.75548 7.16561 3.07224 7.23357 3.36567 7.35996C3.65909 7.48635 3.92318 7.66858 4.14218 7.89578L10.8209 14.3492L21.8979 0.705474C21.9178 0.681735 21.9391 0.659088 21.9617 0.63764H21.9585Z" fill="white"/>
                        </svg>
                    </div>
                ...
                <!-- Item Checkbox -->
                <div class="w-.75/12">
                    <div class="item__checkbox w-[50px] h-[50px] flex justify-center items-center {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'inspection_completed') ? 'bg-blue' : '' }} border-blue border-2 rounded-full z-50">
                        <svg class="" width="26" height="20" viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21.9585 0.63764C22.4078 0.224133 23.0057 -0.0044712 23.626 6.62771e-05C24.2463 0.00460376 24.8406 0.241928 25.2833 0.661961C25.7261 1.08199 25.9828 1.65188 25.9992 2.25137C26.0156 2.85086 25.7904 3.43307 25.3712 3.87513L12.6453 19.2609C12.4265 19.4888 12.1623 19.6716 11.8687 19.7985C11.5751 19.9255 11.2581 19.9938 10.9365 19.9996C10.615 20.0054 10.2955 19.9484 9.99725 19.832C9.69899 19.7157 9.42806 19.5424 9.20066 19.3226L0.761351 11.1641C0.52633 10.9524 0.337826 10.6971 0.207084 10.4134C0.0763413 10.1298 0.00603925 9.82356 0.000372273 9.51306C-0.00529471 9.20256 0.0537896 8.89413 0.174099 8.60619C0.294409 8.31824 0.47348 8.05667 0.700629 7.83708C0.927778 7.61749 1.19835 7.44438 1.49621 7.32807C1.79407 7.21177 2.11311 7.15465 2.43429 7.16013C2.75548 7.16561 3.07224 7.23357 3.36567 7.35996C3.65909 7.48635 3.92318 7.66858 4.14218 7.89578L10.8209 14.3492L21.8979 0.705474C21.9178 0.681735 21.9391 0.659088 21.9617 0.63764H21.9585Z" fill="white"/>
                        </svg>
                    </div>
            ...
            <div class="status__list flex justify-between items-center text-center">
                ...
                <div class="list__item">
                    ...
                    <!-- Item date -->
                    <span class="font-roboto font-light text-sm text-primary">
                        {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'inspector_assigned') ? $trade->get_service_status_date($trade->service_statuses, 'inspector_assigned') : '' }}
                        <br>
                        {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'inspector_assigned') ? $trade->get_service_status_time($trade->service_statuses, 'inspector_assigned') : '' }}
                    </span>
                </div>
                <!-- List Item 4 -->
                <div class="list__item">
                    ...
                    <!-- Item date -->
                    <span class="font-roboto font-light text-sm text-primary">
                        {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'date_of_inspection_finalized') ? $trade->get_service_status_date($trade->service_statuses, 'date_of_inspection_finalized') : '' }}
                        <br>
                        {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'date_of_inspection_finalized') ? $trade->get_service_status_time($trade->service_statuses, 'date_of_inspection_finalized') : '' }}
                    </span>
                </div>
                <!-- List Item 5 -->
                <div class="list__item">
                    ...
                    <!-- Item date -->
                    <span class="font-roboto font-light text-sm text-primary">
                        {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'generating_inspection_report') ? $trade->get_service_status_date($trade->service_statuses, 'generating_inspection_report') : '' }}
                        <br>
                        {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'generating_inspection_report') ? $trade->get_service_status_time($trade->service_statuses, 'generating_inspection_report') : '' }}
                    </span>
                </div>
                <!-- List Item 6 -->
                <div class="list__item">
                    ...
                    <!-- Item date -->
                    <span class="font-roboto font-light text-sm text-primary">
                        {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'inspection_completed') ? $trade->get_service_status_date($trade->service_statuses, 'inspection_completed') : '' }}
                        <br>
                        {{ isset($trade->service_statuses) && $trade->has_service_status($trade->service_statuses, 'inspection_completed') ? $trade->get_service_status_time($trade->service_statuses, 'inspection_completed') : '' }}
                    </span>
                </div>
            </div>
        </div>
            ...
            <table>
                <tbody>
                    <tr class="">
                        ...
                        <td class="w-9/12 font-roboto font-normal text-base text-primary">{{ $trade->trade_inspections->location }}</td>
                    </tr>
                    <tr class="">
                    ...
                    <tr class="">
                        ...
                        <td class="px-2 sm:px-8">:</td>
                        <td class="w-9/12 font-roboto font-normal text-base text-primary">${{ $trade->trade_inspections->service_charge }}</td>
                    </tr>
                    <tr class="">
                        <th class="w-3/12 text-start font-roboto font-medium text-base text-primary leading-6 py-2">Current Status</th>
                        <td class="px-2 sm:px-8">:</td>
                        <td class="w-9/12 font-roboto font-normal text-base text-primary">{{ ucfirst(str_replace('_', ' ', $trade->trade_inspections->status)) }}</td>
                    </tr>
                    <tr class="">
                        <th class="w-3/12 text-start font-roboto font-medium text-base text-primary leading-6 py-2">Payment Status</th>
                        <td class="px-2 sm:px-8">:</td>
                        <td class="w-9/12 font-roboto font-normal text-base text-primary">{{ ucfirst(str_replace('_', ' ', $trade->trade_inspections->payment_status)) }}</td>
                    </tr>
                    <tr class="">
                        <th class="w-3/12 text-start font-roboto font-medium text-base text-primary leading-6 py-2">Instruction</th>
                        <td class="px-2 sm:px-8">:</td>
                        <td class="w-9/12 font-roboto font-normal text-base text-primary">{{ isset($trade->trade_inspections->instruction) ? $trade->trade_inspections->instruction->note : '' }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
