            ...
            <div class="dashboard__details px-5 md:px-10 w-5/6 ml-auto border-l">
                ...
                <div class="dashboard__profile border py-3 px-4 mb-[30px]">
                    ...
                    <div class="flex flex-wrap justify-start md:justify-between items-center">
                        <table class="table-fixed w-full md:w-[70%] lg:w-3/5 order-2 md:order-1">
                            <tbody>
                                <tr class="">
                                    <td class="w-full block sm:table-cell sm:w-1/4 py-4 font-roboto font-semibold text-sm text-[#9E9E9E]">Name</td>
                                    <td class="w-full sm:w-3/4 py-4 font-roboto font-normal text-sm text-[#1D1D1F]">
                                        <input type="text" class="w-full border px-4 rounded-sm py-3 bg-card focus:outline-none focus:bg-white" value="{{ App\Helpers\NameConversionHelper::generateAuthUserFullName() }}" placeholder="Enter your name">
                                    </td>
                                    <!-- <td class="w-0 sm:w-1/4 py-4">&nbsp;</td> -->
                                </tr>
                                <tr class="">
                                    <td class="w-full block sm:table-cell sm:w-1/4 py-4 font-roboto font-semibold text-sm text-[#9E9E9E]">Date of birth</td>
                                    <td class="w-full sm:w-3/4 py-4 font-roboto font-normal text-sm text-[#1D1D1F]">
                                        <input type="date" class="w-full border px-4 rounded-sm py-3 bg-card focus:outline-none focus:bg-white" value="{{ auth()->user()->date_of_birth }}" placeholder="Enter your birth date">
                                    </td>
                                    <!-- <td class="w-0 sm:w-1/4 py-4">&nbsp;</td> -->
                                </tr>
                                <tr class="">
                                    ...
                                    <td class="w-full sm:w-3/4 py-4 font-roboto font-normal text-sm text-[#1D1D1F]">
                                        <input type="text" class="w-full border px-4 rounded-sm py-3 bg-card focus:outline-none focus:bg-white" value="{{ auth()->user()->address }}" placeholder="Enter your address">
                                    </td>
                                    <!-- <td class="w-0 sm:w-1/4 py-4">&nbsp;</td> -->
                                </tr>
                                ...
                                <tr class="">
                                    ...
                                    <td class="w-full sm:w-3/4 py-4 font-roboto font-normal text-sm text-[#1D1D1F]">
                                        <input type="text" class="w-full border px-4 rounded-sm py-3 bg-card focus:outline-none focus:bg-white" value="{{ auth()->user()->email }}" placeholder="Enter your email">
                                    </td>
                                    <!-- <td class="w-0 sm:w-1/4 py-4">&nbsp;</td> -->
                                </tr>
                                <tr class="">
                                    ...
                                    <td class="w-full sm:w-3/4 py-4 font-roboto font-normal text-sm text-[#1D1D1F]">
                                        <input type="text" class="w-full border px-4 rounded-sm py-3 bg-card focus:outline-none focus:bg-card read-only:text-[#9E9E9E] read-only:cursor-not-allowed" value="{{ auth()->user()->phone_no }}" title="You are not allow to update phone number" readonly>
                                    </td>
                                    <!-- <td class="w-0 sm:w-1/4 py-4">&nbsp;</td> -->
                                </tr>
                            </tbody>
                        </table>
                        <div class="profile-img text-center w-full md:w-1/4 lg:w-2/5 order-1 md:order-2">
                            ...
                            <div class="mt-3">
                                <label for="dropzone-file" class="upload-img mt-3 border-secondary border text-xs font-medium px-3 py-1 hover:border-primary hover:text-primary rounded-sm transition-all ease-in-out duration-300 text-[#9E9E9E] cursor-pointer">
                                    Upload photo
                    ...
                    <!-- Update Button -->
                    <div class="btn update-btn text-center md:text-right">
                        <button class="text-center text-primary bg-white text-sm leading-[18px] font-semibold px-6 py-2 border-2 border-primary hover:bg-primary hover:text-white transition ease-in-out duration-500 rounded inline-block">Update</button>
                    </div>
                </div>
            </div>
