                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td class="px-2 sm:px-8">:</td>
                                <td class="w-9/12 font-roboto font-normal text-base text-primary">Both parties Agreed</td>
                            </tr>
                            <tr class="">
                            ...
                            <tr class="">
                                ...
                                <td class="px-2 sm:px-8">:</td>
                                <td class="w-9/12 font-roboto font-normal text-base text-primary">Please transfer the exact amount to the carsaround trust account and provide us with the proof of transaction.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
