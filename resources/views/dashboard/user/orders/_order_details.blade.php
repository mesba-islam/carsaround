            ...
            <!-- Dashboard Details -->
                        ...
                        <div class="dashboard__details w-5/6 ml-auto border-l">
                            ...
                            <div class="details-id pt-16 md:flex md:gap-8 lg:gap-[60px] xl:gap-[120px] px-5 md:px-10">
                                <!-- Id Vehicle -->
                                <div class="id__vehicle w-full md:w-1/2">
                                    <!-- Image -->
                                    <img class="rounded-md w-full" src="{{ asset('/assets/img/dashboard/b3228938291.jpg') }}" alt="img">
                                    <!-- Vehicle Title -->
                                    <div class="relative mt-[80px] mb-[100px]">
                                        ...
                                        <h2 class="vehicle__title font-roboto font-medium text-3xl text-primary flex justify-center items-center text-center left-0 right-0 absolute bottom-0 w-4/6 mx-auto">
                                            2018 Toyota RAV4
                                        </h2>
                                ...
                                <!-- Id Details -->
                                <div class="id__details w-full md:w-1/2">
                                    <table>
                                        <tbody>
                                            <tr class="py-4">
                                                <th class="w-1/2 pb-5 text-start font-roboto font-semibold text-base text-primary">Trade Key</th>
                                                <td class="px-4">:</td>
                                                <td class="w-1/2 font-roboto font-normal text-base text-primary">b3228938291</td>
                                            </tr>
                                            <tr class="py-4">
                                                <th class="w-1/2 pb-5 text-start font-roboto font-semibold text-base text-primary">Vehicle Type</th>
                                                <td class="px-4">:</td>
                                                <td class="w-1/2 font-roboto font-normal text-base text-primary">Car</td>
                                            </tr>
                                            <tr class="py-4">
                                                <th class="w-1/2 pb-5 text-start font-roboto font-semibold text-base text-primary">Make</th>
                                                <td class="px-4">:</td>
                                                <td class="w-1/2 font-roboto font-normal text-base text-primary">Toyota</td>
                                            </tr>
                                            <tr class="py-4">
                                                <th class="w-1/2 pb-5 text-start font-roboto font-semibold text-base text-primary">Model</th>
                                                <td class="px-4">:</td>
                                                <td class="w-1/2 font-roboto font-normal text-base text-primary">RAV4</td>
                                            </tr>
                                            <tr class="py-4">
                                                <th class="w-1/2 pb-5 text-start font-roboto font-semibold text-base text-primary">Year</th>
                                                <td class="px-4">:</td>
                                                <td class="w-1/2 font-roboto font-normal text-base text-primary">2018</td>
                                            </tr>
                                            <tr class="py-4">
                                                <th class="w-1/2 pb-5 text-start font-roboto font-semibold text-base text-primary">Odometer</th>
                                                <td class="px-4">:</td>
                                                <td class="w-1/2 font-roboto font-normal text-base text-primary">63504 km</td>
                                            </tr>
                                            <tr class="py-4">
                                                <th class="w-1/2 pb-5 text-start font-roboto font-semibold text-base text-primary">Registration no./VIN</th>
                                                <td class="px-4">:</td>
                                                <td class="w-1/2 font-roboto font-normal text-base text-primary">JTMZDREV10J185318</td>
                                            </tr>
                                            <tr class="py-4">
                                                <th class="w-1/2 pb-5 text-start font-roboto font-semibold text-base text-primary">Territory Registered</th>
                                                <td class="px-4">:</td>
                                                <td class="w-1/2 font-roboto font-normal text-base text-primary">Queensland</td>
                                            </tr>
                                            <tr class="py-4">
                                                <th class="w-1/2 pb-5 text-start font-roboto font-semibold text-base text-primary">Seller</th>
                                                <td class="px-4">:</td>
                                                <td class="w-1/2 font-roboto font-normal text-base text-primary">Edward Bale 04 3322 432</td>
                                            </tr>
                                            <tr class="py-4">
                                                <th class="w-1/2 pb-5 text-start font-roboto font-semibold text-base text-primary">Buyer</th>
                                                <td class="px-4">:</td>
                                                <td class="w-1/2 font-roboto font-normal text-base text-primary">Edward Bale 04 3322 432</td>
                                            </tr>
                                        </tbody>
                            ...
                            <!-- Vehicle Status -->
                            <div class="vehicle__status pb-20 px-5 md:px-10">
                                <!-- Status Checkbox -->
                                ...
                                <div class="status__list flex justify-between items-center text-center">
                                    ...
                                    <div class="list__item">
                                        <!-- Item Title -->
                                        <h2 class="item__title font-roboto font-medium text-base text-primary mt-5 mb-3">
                                            Inspection
                                        </h2>
                                        <!-- Item Btn -->
                                        <button onclick="window.location.href='{{ route('order_inspection') }}'" class="px-4 h-10 bg-primary font-roboto font-semibold text-sm text-white tracking-[.25px] rounded">
                                            Track
                                        </button>
                                    </div>
                                    <!-- List Item 2 -->
                                    <div class="list__item">
                                        ...
                                        <!-- Item Btn -->
                                        <button onclick="window.location.href='{{ route('order_finance') }}'" class="px-4 h-10 bg-primary font-roboto font-semibold text-sm text-white tracking-[.25px] rounded">
                                            Track
                                        </button>
                                    </div>
                                    <!-- List Item 3 -->
                                    <div class="list__item">
                                        ...
                                        <!-- Item Btn -->
                                        <button onclick="window.location.href='{{ route('order_safe_settlement') }}'" class="px-4 h-10 bg-primary font-roboto font-semibold text-sm text-white tracking-[.25px] rounded">
                                            Track
                                        </button>
                                    </div>
                                    <!-- List Item 4  -->
                                    <div class="list__item">
                                        ...
                                        <!-- Item Btn -->
                                        <button class="px-4 h-10 bg-primary font-roboto font-semibold text-sm text-white tracking-[.25px] rounded">
                                            Apply Now
                                        </button>
                                    </div>
                                </div>
                            ...
                            <!-- Drop-down Section -->
                            <div class="drop-down pt-5 px-5 md:px-10 mb-10">
                                <!-- Drop down Title -->
                                ...
                                <div class="pt-6">
                                    <label class="justify-center items-center flex h-[294px] bg-card hover:bg-opacity-50 cursor-pointer border-dashed border-2 border-transparent hover:border-secondaryDark rounded-md transition-all ease-in-out duration-300">
                                        ...
                                        <div class="drop-down__file text-center">
                                            ...
                                            <!-- Select file -->
                                            <h3 class="file-upload bg-bgc text-white rounded-lg py-1">
                            ...
                            <!-- Note Section -->
                            <div class="note pt-5 px-5 md:px-10 mb-10">
                                <!-- Drop down Title -->
                                ...
                                <form action="#" class="pt-6 text-end">
                                    ...
                                    <button class="py-2 px-6 mt-6 border-2 border-primary rounded font-roboto font-semibold text-sm text-white bg-primary hover:bg-transparent hover:text-primary transition-all ease-in-out duration-300">
                                        Submit
                                    </button>
                                </form>
                            </div>
                            <!-- Documents Section -->
                            <div class="documents pt-5 px-5 md:px-10 mb-10">
                                <!-- Documents Title -->
                                ...
                                <div class="documents__table mt-8 overflow-y-scroll h-[500px]">
                                    <table class="table-fixed w-full border-2 rounded-full">
                                        <thead>
                                            <tr class="border-b-2">
