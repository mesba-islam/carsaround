...
@section('content')
    ...
    <div class="banner pt-24 lg:pt-32 pb-14 flex items-center justify-center text-center">
        <div class="lg:container mx-auto lg:max-w-screen-lg px-5 md:px-8 lg:px-15 relative">
            <div class="banner__heading">
                <!-- Hero Title -->
                <h2
                    class="hero__title text-primary font-inter font-semibold text-4xl sm:text-5xl lg:text-6xl uppercase">
                    Contact Us
                </h2>
                <!-- Hero Sub Title -->
                <p class="hero__sub-title text-primary font-inter font-normal text-lg">
    ...
    <div class="contact-content pb-16">
        <div class="lg:container mx-auto lg:max-w-screen-lg px-5 md:px-8 lg:px-15">
            ...
            <div class="contact__card pt-4">
                <ul class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 space-y-6 sm:space-y-0 sm:gap-10 md:gap-5">
                    <li class="relative">
                        <input class="sr-only peer" type="radio" name="selling" id="buyer">
                        <!-- Buying Section -->
                        <label
                            class="text-center font-roboto font-semibold text-primary text-lg p-5 peer-hover:bg-primary peer-hover:text-secondary peer-checked:bg-primary border-[1px] border-primary cursor-pointer w-full inline-block rounded-md peer-checked:text-secondary"
                    ...
                    <li class="relative flex md:justify-end">
                        <input class="sr-only peer" type="radio" name="selling" id="media">
                        <!-- Selling Section -->
                        <label
                            class="text-center font-roboto font-semibold text-primary text-lg p-5 peer-hover:bg-primary peer-hover:text-secondary peer-checked:bg-primary border-[1px] border-primary cursor-pointer  w-full inline-block rounded-md peer-checked:text-secondary"
                            for="media">Media</label>
                    </li>
                    <li class="relative flex md:justify-end">
                        <input class="sr-only peer" type="radio" name="selling" id="others">
                        <!-- Selling Section -->
                        <label
                            class="text-center font-roboto font-semibold text-primary text-lg p-5 peer-hover:bg-primary peer-hover:text-secondary peer-checked:bg-primary border-[1px] border-primary cursor-pointer  w-full inline-block rounded-md peer-checked:text-secondary"
    ...
    <div class="contact-content pb-16">
        <div class="lg:container mx-auto lg:max-w-screen-lg px-5 md:px-8 lg:px-15">
            ...
            <!-- Contact Card -->
            <div class="contact__card grid pt-4">
                <ul class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 space-y-6 sm:space-y-0 sm:gap-10 md:gap-5">
                    <li class="relative flex flex-col items-center">
                        <input class="sr-only peer" type="radio" name="platforms" id="service">
                        <!-- Service Section -->
                        <label
                            class="flex items-center justify-center text-center font-roboto font-semibold text-primary bg-white text-lg p-5 peer-checked:bg-primary border-[1px] border-primary cursor-pointer w-full rounded-md peer-checked:text-white flex-1 peer-hover:bg-primary peer-hover:text-secondary"
                            for="service">
                            Service
                        </label>
                    </li>
                    <li class="relative flex flex-col">
                        <input class="sr-only peer" type="radio" name="platforms" id="general">
                        <!-- General Section -->
                        <label
                            class="flex items-center justify-center text-center font-roboto font-semibold text-primary bg-white text-lg p-5 peer-checked:bg-primary border-[1px] border-primary cursor-pointer w-full rounded-md peer-checked:text-white flex-1 peer-hover:bg-primary peer-hover:text-secondary"
                            for="general">
                    ...
                    <li class="relative flex flex-col">
                        <input class="sr-only peer" type="radio" name="platforms" id="suggestion">
                        <!-- Suggestion Section -->
                        <label
                            class="flex items-center justify-center text-center font-roboto font-semibold text-primary bg-white text-lg p-5 peer-checked:bg-primary border-[1px] border-primary cursor-pointer w-full rounded-md peer-checked:text-white flex-1 peer-hover:bg-primary peer-hover:text-secondary"
                            for="suggestion">
                    ...
                    <li class="relative flex flex-col">
                        <input class="sr-only peer" type="radio" name="platforms" id="partnership">
                        <!-- Partnership Section -->
                        <label
                            class="flex items-center justify-center text-center font-roboto font-semibold text-primary bg-white text-lg p-5 peer-checked:bg-primary border-[1px] border-primary cursor-pointer w-full rounded-md peer-checked:text-white flex-1 peer-hover:bg-primary peer-hover:text-secondary"
                            for="partnership">
    ...
    <div class="form pt-10">
        <div class="lg:container mx-auto lg:max-w-screen-lg px-5 md:px-8 lg:px-15">
                <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-y-8 md:gap-8 lg:gap-18 xl:gap-48 mb-4">
                    <div class="w-full space-y-6">
                        <!-- Name -->
                        <div class="name-field">
                            <label for="name"
                                class="w-full name font-roboto text-sm  text-primary font-light pb-2">
                                Full Name *
                            </label>
                            <input
                                class="pl-6 w-full h-16 bg-card p-2 font-roboto text-sm leading-6 focus:outline-none focus:bg-white border-2 border-transparent focus:border-card rounded"
                                type="text" name="Name" id="name" placeholder="Cameron" required>
                        </div>
                        <!-- Contact -->
                        <div class="contact-field">
                            <label for="contact"
                                class="w-full contact font-roboto text-sm  text-primary font-light pb-2">
                                Contact Number *
                            </label>
                            <input
                                class="pl-6 w-full h-16 bg-card p-2 font-roboto text-sm leading-6 focus:outline-none focus:bg-white border-2 border-transparent focus:border-card rounded"
                                type="text" name="contact" id="contact" placeholder="04  123 456 789" required>
                        </div>
                    </div>
                    <div class="w-full space-y-6">
                        <!-- Email -->
                        <div class="email-field">
                            <label for="email"
                                class="w-full email font-roboto text-sm  text-primary font-light pb-2">
                                Email *
                            </label>
                            <input
                                class="pl-6 w-full h-16 bg-card p-2 font-roboto text-sm leading-6 focus:outline-none focus:bg-white border-2 border-transparent focus:border-card rounded"
                                type="text" name="Email" id="email" placeholder="debra.holt@example.com" required>
                        </div>
                        <!-- Trade Key -->
                        <div class="trade-key-field">
                            <label for="trade-key"
                                class="w-full contact font-roboto text-sm  text-primary font-light pb-2">
                                Trade Key
                            </label>
                            <input
                                class="pl-6 w-full h-16 bg-card p-2 font-roboto text-sm leading-6 focus:outline-none focus:bg-white border-2 border-transparent focus:border-card rounded"
                                type="text" name="contact" id="trade-key" placeholder="b3237928321" required>
                        </div>
                    </div>
                </div>
                <!-- Message -->
                <div class="message-field pt-2">
                    <label for="message"
                        class="message font-roboto text-sm  text-primary font-light">
                        Your Message *
                    </label>
                    <div class="bg-card border-b-2 border-white flex rounded-t">
                        <ul class="flex justify-center items-center gap-3 sm:gap-5 px-4 sm:px-8 py-4 sm:py-6 m-0 border-r-2 border-white">
                            <!-- Bold Icon -->
                            <li class="bold-icon">
                                <button>
                                    <svg class="xs:w-4 xs:h-4" width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="italic-icon">
                                <button>
                                    <svg class="xs:w-4 xs:h-4" width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="underline-icon">
                                <button>
                                    <svg class="xs:w-5 xs:h-4" width="23" height="26" viewBox="0 0 23 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="flex justify-center items-center gap-3 sm:gap-5 px-4 sm:px-8 py-4 sm:py-6 m-0 border-r-2 border-white">
                            ...
                            <li class="ordered-list-icon">
                                <button>
                                    <svg class="xs:w-5 xs:h-4" width="28" height="30" viewBox="0 0 28 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="unordered-list-icon">
                                <button>
                                    <svg class="xs:w-5 xs:h-4" width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="flex justify-center items-center gap-3 sm:gap-5 px-4 sm:px-8 py-4 sm:py-6 m-0 border-r-2 border-white">
                            ...
                            <li class="link-icon">
                                <button>
                                    <svg class="xs:w-5 xs:h-4" width="44" height="22" viewBox="0 0 44 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="image-icon">
                                <button>
                                    <svg class="xs:w-5 xs:h-4" width="35" height="32" viewBox="0 0 35 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <textarea name="text" id="mess" cols="" rows="" placeholder="Please type your message here" class="pl-6 w-full h-16 bg-card p-2 font-roboto text-sm leading-6 focus:outline-none focus:bg-white border-2 border-transparent focus:border-card rounded-b resize-none"></textarea>
                </div>
                <!-- Contact Button -->
                <div class="contact__button text-center p-16">
                    <button type="submit" class="work__btn w-40 text-center text-primary bg-white f text-base leading-[18px] font-semibold px-6 py-[14px] border-2 border-primary hover:bg-primary hover:text-white transition ease-in-out duration-500 rounded inline-block">
                            Submit
                    </button>
                </div>
        </div>
    ...
    <div class="contact__card md:pb-32">
        <div class="lg:container mx-auto lg:max-w-screen-lg px-5 md:px-8 lg:px-15">
            ...
            <div class="flex flex-wrap justify-between items-center gap-y-5 md:gap-y-0">
                <a href="mailto:ratib@carsaround.com.au" class="flex flex-col group w-full sm:w-[48%] md:w-[30%] py-10 bg-card hover:bg-secondaryDark text-center rounded-md transition-all ease-in-out duration-300">
                ...
                <a href="tel:1800 010 001" class="flex flex-col group w-full sm:w-[48%] md:w-[30%] py-10 bg-card hover:bg-secondaryDark text-center rounded-md transition-all ease-in-out duration-300">
                    <div class="flex justify-center items-center w-full ">
                        <div class="list-icon inline-flex justify-center border-2 w-24 h-24 rounded-full items-center mb-5 border-secondaryDark group-hover:border-primary">
                            <div class="list-icon--inner flex justify-center items-center bg-transparent group-hover:bg-primary w-20 h-20 rounded-full">
                ...
                <a href="https://www.google.com/maps/place/carsaround/@-37.8142431,144.9380891,17z/data=!3m2!4b1!5s0x6b27c1ba28273d99:0x37944fe5e25a0576!4m5!3m4!1s0x6ad65d5290ba4e99:0xf3f3affa04883870!8m2!3d-37.8142474!4d144.9402778?coh=164777&entry=tt&shorturl=1" target="_blank" class="flex flex-col group w-full sm:w-[48%] md:w-[30%] py-10 bg-card hover:bg-secondaryDark text-center rounded-md transition-all ease-in-out duration-300">
                    <div class="flex justify-center items-center w-full ">
                        <div class="list-icon inline-flex justify-center border-2 w-24 h-24 rounded-full items-center mb-5 border-secondaryDark group-hover:border-primary">
                            <div class="list-icon--inner flex justify-center items-center bg-transparent group-hover:bg-primary w-20 h-20 rounded-full">
