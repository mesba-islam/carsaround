        ...
        <div class="lg:container mx-auto lg:max-w-screen-2xl px-5 md:px-8 lg:px-15">
            ...
            <div class="safe-settlement__form">
                    <div class="py-[2px] relative flex flex-wrap items-center rounded-md">
                        <!-- Dolor Sign -->
                        <label for="safe-settlement-amount" class="rounded-tl-md rounded-bl-md absolute left-0 top-0 font-roboto font-semibold text-[40px] text-primary bg-[#E6E6E6] px-3">
                            $
                        </label>
                        <!-- Amount Fild -->
                        <input class="border w-full outline-none font-roboto font-normal text-3xl px-20 rounded-md py-[10px]" type="number" x-model="safe_settlement_data.safe_settlement_price" id="safe-settlement-amount" pattrn="[0-9]" placeholder="23442">
                        @error('safe_settlement_price') <span class="error">{{ $message }}</span> @enderror
                        <!-- Fees Check Button -->
                        <button onclick="calculateFees()" class="fees-check__btn absolute top-[10px] right-2 bg-[#E6E6E6] font-roboto font-semibold text-base text-[#231F20] py-2 rounded-md px-12">
                            Check Fees
                        </button>
                    </div>
                    <!-- Error Message -->
                    <small class="error-msg text-red-600 bg-transparent text-xs hidden pl-2" id="error-msg">Must contains a valid number</small>
                    <!-- Your Fees Check -->
                    <div class="fees-check__body pt-[73px] pb-[70px] lg:w-1/2 mx-auto hidden" id="safeSettlementFees">
                        <!-- Fees Check Title -->
                        ...
                        <input type="text" x-model="safe_settlement_data.safe_settlement_service_charge" class="fees-check__fild bg-card w-full inline-block text-center font-roboto font-semibold text-3xl tracking-[0.25px] text-[#231F20] rounded py-[14px] focus:ring-0 focus:outline-none read-only" readonly name="" id="" value="395">
                    </div>
                    <!-- Button -->
                    <div class="button flex justify-end gap-4 sm:gap-10 pt-[73px]">
