    ...
    <div class="vehicle-info mt-[52px] pb-20">
        <div class="lg:container mx-auto lg:max-w-screen-2xl px-5 md:px-8 lg:px-15">
            ...
            <div class="vehicle__heading">
                <!-- Vehicle Title -->
                <h2 class="vehicle__title font-roboto text-2xl font-medium text-blue">
                    Please enter the vehicle info:
                </h2>
                <!-- Vehicle Sub-title -->
                <h5 class="vehicle__sub-title font-roboto text-base font-normal pt-6 text-blue">
            ...
            <div class="vehicle__card grid pt-4">
                ...
                <ul
                    ...
                    <li class="relative flex flex-col items-center vehicle__item">
                        <input class="sr-only peer" type="radio" x-model="vehicle_info.type" id="manual-car-seller" value="car">

                        <!-- Car Section -->
                        <label
                            class="flex items-center justify-center text-center font-roboto font-medium text-primary text-lg  bg-white border border-primary p-5 peer-checked:bg-primary cursor-pointer w-full rounded-md peer-checked:text-white  flex-1 peer-hover:bg-primary peer-hover:text-secondary  transition-all ease-in-out duration-300"
                            for="manual-car-seller">
                            Car
                        </label>
                    </li>
                    <!-- Vehicle Item -->
                    <li class="relative flex flex-col vehicle__item">
                        <input class="sr-only peer" type="radio" x-model="vehicle_info.type" id="manual-bike-seller" value="bike">

                        <!-- Bike Section -->
                        <label
                            class="flex items-center justify-center text-center font-roboto font-medium text-primary text-lg  bg-white border border-primary p-5 peer-checked:bg-primary cursor-pointer w-full rounded-md peer-checked:text-white  flex-1 peer-hover:bg-primary peer-hover:text-secondary  transition-all ease-in-out duration-300"
                            for="manual-bike-seller">
                            Bike
                        </label>
                    </li>
                    <!-- Vehicle Item -->
                    <li class="relative flex flex-col vehicle__item">
                        <input class="sr-only peer" type="radio" x-model="vehicle_info.type" id="manual-boat-seller" value="boat">

                        <!-- Boat Section -->
                        <label
                            class="flex items-center justify-center text-center font-roboto font-medium text-primary text-lg  bg-white border border-primary p-5 peer-checked:bg-primary cursor-pointer w-full rounded-md peer-checked:text-white  flex-1 peer-hover:bg-primary peer-hover:text-secondary  transition-all ease-in-out duration-300"
                            for="manual-boat-seller">
                            Boat
                        </label>
                    </li>
                    <!-- Vehicle Item -->
                    <li class="relative flex flex-col vehicle__item">
                        <input class="sr-only peer" type="radio" x-model="vehicle_info.type" id="manual-caravan-seller" value="caravan">

                        <!-- Caravan Section -->
                        <label
                            class="flex items-center justify-center text-center font-roboto font-medium text-primary text-lg  bg-white border border-primary p-5 peer-checked:bg-primary cursor-pointer w-full rounded-md peer-checked:text-white  flex-1 peer-hover:bg-primary peer-hover:text-secondary  transition-all ease-in-out duration-300"
                            for="manual-caravan-seller">
                            Caravan
                        </label>
                    </li>
        ...
        <div class="px-5 mx-auto lg:container lg:max-w-screen-2xl md:px-8 lg:px-15">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-[30px] lg:gap-x-20">
                    ...
                    <div class="flex flex-wrap justify-start w-full make-field">
                        <label for="make-seller"
                            class="make font-roboto text-sm leading-6  tracking-[0.25px] text-primary font-light">
                            Make*
                        </label>
                        <input
                            class="pl-6 w-full h-[64px] bg-card p-2 font-roboto text-sm leading-6 focus:outline-none border border-transparent focus:bg-transparent focus:border-secondaryDark rounded-md text-primary"
                            type="text" x-model="vehicle_info.make" id="make-seller" placeholder="Mercedes-Benz" required>
                    ...
                    <div class="flex flex-wrap justify-start w-full odometer-field">
                        <label for="odometer-seller"
                            class="odometer font-roboto text-sm leading-6 tracking-[0.25px] text-primary font-light">
                            Odometer
                        </label>
                        <input
                            class="pl-6 w-full h-[64px] bg-card p-2 font-roboto text-sm leading-6 focus:outline-none border border-transparent focus:bg-transparent focus:border-secondaryDark rounded-md text-primary"
                            type="number" x-model="vehicle_info.odometer" id="odometer-seller" placeholder="19,525 km">
                            @error('odometer') <span class="error text-xs text-red-600">{{ $message }}</span> @enderror
                        </div>
                    <!-- Model -->
                    <div class="flex flex-wrap justify-start w-full model-field">
                        <label for="model-seller"
                            class="model font-roboto text-sm leading-6 tracking-[0.25px] text-primary font-light">
                            Model*
                        </label>
                        <input
                            class="pl-6 w-full h-[64px] bg-card p-2 font-roboto text-sm leading-6 focus:outline-none border border-transparent focus:bg-transparent focus:border-secondaryDark rounded-md text-primary"
                            type="text" x-model="vehicle_info.model" id="model-seller" placeholder="E-Class" required>
                    ...
                    <div class="flex flex-wrap justify-start w-full registration-field">
                        <label for="registration-seller"
                            class="registration font-roboto text-sm leading-6 tracking-[0.25px] text-primary font-light">
                            Registration Number/VIN
                        </label>
                        <input
                            class="pl-6 w-full h-[64px] bg-card p-2 font-roboto text-sm leading-6 focus:outline-none border border-transparent focus:bg-transparent focus:border-secondaryDark rounded-md text-primary"
                            type="text" x-model="vehicle_info.registration_number" id="registration-seller" placeholder="2HKRM4H78EH668417">
                    ...
                    <div class="flex flex-wrap justify-start w-full year__field">
                        <label for="year-seller"
                            class="year font-roboto text-sm leading-6 tracking-[0.25px] text-primary font-light">
                            Year*
                        </label>
                        <input
                            class="pl-6 w-full h-[64px] bg-card p-2 font-roboto text-sm leading-6 focus:outline-none border border-transparent focus:bg-transparent focus:border-secondaryDark rounded-md text-primary"
                            type="year" x-model="vehicle_info.year" id="year-seller" placeholder="2020" required>
                    ...
                    <!-- Vehicle Price -->
                    <div class="flex flex-wrap justify-start w-full state__field">
                        <label for="vehicle_price-seller"
                            class="w-4/5 vehicle_price font-roboto text-sm leading-6 tracking-[0.25px] text-primary font-light">
                            Vehicle Price*
                        </label>
                        <input
                            class="pl-6 w-full h-[64px] bg-card p-2 font-roboto text-sm leading-6 focus:outline-none border border-transparent focus:bg-transparent focus:border-secondaryDark rounded-md text-primary"
                            type="text" x-model="vehicle_info.vehicle_price" id="vehicle_price-seller" placeholder="2HKRM4H78EH668417">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-[30px] lg:gap-x-20">
                    ...
                    <div class="flex flex-wrap justify-start w-full full__name-field">
                        ...
                        <input
                            ...
                            type="text" x-model="vehicle_info.buyer_name" name="buyer_name" id="full__name" placeholder="Cameron Williamson">
                            @error('buyer_name') <span class="text-xs text-red-600 error">{{ $message }}</span> @enderror
                        </div>
                    <!-- Email address -->
                    <div class="flex flex-wrap justify-start w-full email-field">
                        ...
                        <input
                            class="w-full h-16 p-2 pl-6 text-sm leading-6 border border-transparent rounded-md bg-card font-roboto focus:outline-none focus:bg-transparent focus:border-secondaryDark text-primary"
                            type="text" x-model="vehicle_info.buyer_email" name="buyer_email" id="email" placeholder="debbie.baker@example.com">
                            @error('buyer_email') <span class="text-xs text-red-600 error">{{ $message }}</span> @enderror
                        </div>
                    <!-- Contact Number -->
                    <div class="flex flex-wrap justify-start w-full contact__number-field">
                        ...
                        <input
                            class="w-full h-16 p-2 pl-6 text-sm leading-6 border border-transparent rounded-md bg-card font-roboto focus:outline-none focus:bg-transparent focus:border-secondaryDark text-primary"
                            type="number" x-model="vehicle_info.buyer_number" name="buyer_number" id="contact__number" placeholder="04 123 456 789"
                            required>
                           @error('buyer_number') <span class="text-xs text-red-600 error">{{ $message }}</span> @enderror
                    </div>
                </div>
                <!-- Contact Button -->
